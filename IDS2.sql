DROP TABLE Udalost_zamestnance CASCADE CONSTRAINTS PURGE;
...
VALUES (1,  7902173675, 'Jan', 'Pajtl', 'RED');

INSERT INTO Zamestnanec (c_zamestnance, rodne_c, jmeno, prijmeni, role, kod_oddeleni_zamestnance)
VALUES (2,  8406087415, 'Petr', 'Kubala', 'MAN', 'FIN');

INSERT INTO Zamestnanec (c_zamestnance, rodne_c, jmeno, prijmeni, role, kod_oddeleni_zamestnance)
VALUES (3, 8959156349, 'Tereza', 'Doubravová', 'MAN', 'HR');

INSERT INTO Zamestnanec (c_zamestnance, rodne_c, jmeno, prijmeni, role, kod_oddeleni_zamestnance)
VALUES (4, 7656217701, 'Soňa', 'Peštová', 'SEK', 'FIN');

INSERT INTO Zamestnanec (c_zamestnance, rodne_c, jmeno, prijmeni, role, id_nadrizeny_reditel)
VALUES (5,  9258087894, 'Eva', 'Modrá', 'SEK', 1);

INSERT INTO Zamestnanec (c_zamestnance, rodne_c, jmeno, prijmeni, role, kod_oddeleni_zamestnance)
VALUES (6,  6553157160, 'Anna', 'Zoufalá', 'SEK', 'FIN');
...
INSERT INTO Udalost (datum_cas_od, datum_cas_do, nazev, misto_konani, popis, id_autor)
VALUES ( TO_DATE('22.4.2022 14:00', 'DD.MM.YYYY HH24:MI'), TO_DATE('22.4.2022 18:00', 'DD.MM.YYYY HH24:MI'), 'Návštěva dodavatelů', 'Areál firmy', 'Provedení firmou, jednání v konferenčce, poté raut ve vstupní hale.', 5);
